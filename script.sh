...
curl -fsSL https://deliveryinstallresources.younesfakallah.com/compose.prod.yaml -o /data/delivery/source/compose.prod.yaml
...
curl -fsSL https://deliveryinstallresources.younesfakallah.com/dynamic.yaml -o /data/delivery/source/infrastructure/traefik-config/dynamic.yaml
curl -fsSL https://deliveryinstallresources.younesfakallah.com/traefik.yaml -o /data/delivery/source/infrastructure/traefik-config/traefik.yaml
curl -fsSL https://deliveryinstallresources.younesfakallah.com/env.production -o /data/delivery/source/.env.production
